...
class AppRouter:
    def db_for_read(self,model,**hints):
        if model._meta.app_label=='book_api':
            return 'BOOKS'
        else:
            return 'default'
        return None
    ...
    def allow_relation(self,obj1,obj2,**hints):
        if obj1._meta.app_label=='book_api'or \
            obj2._meta.app_label=='book_api':
            return True 
        else:
            return True
        return None
...
#            obj2._meta.app_label == 'book_api':
#            return True
#         elif obj1._meta.app_label == 'models' or \
